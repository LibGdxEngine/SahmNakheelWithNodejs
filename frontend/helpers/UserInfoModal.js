...
const UserInfoModal = ({ children, isOpen, onClose, onBlock }) => {
  return (
    <>
      <AnimatePresence>
        {isOpen ? (
          <motion.div
            className="w-full absolute bg-dark/90 z-10 top-[0%] inset-0 overflow-y-scroll"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              >
                <div
                  className="w-full h-96 overflow-y-scroll p-4"
